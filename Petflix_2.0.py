...
MORAL_TAX_TRIGGERS = [
    (r"\bbitte\b", "Bitte? Als ob du je was umsonst kriegst, du kleine Bettel-Prinzessin. −{deduct} Coins fürs Winseln."),
    (r"\bdanke\b", "Danke? Süß, als ob du was verdient hättest. Nächstes Mal mit Knien, du undankbare kleine Schlampe. −{deduct} Coins."),
    (r"\bentschuldigung\b", "Entschuldigung? Als ob ich dir je verzeihen würde, ohne dass du richtig leidest. −{deduct} Coins."),
    (r"\bsorry\b", "Sorry not sorry – aber du sagst’s eh nur, um mich heiß zu machen, du kleine Manipuliererin. −{deduct} Coins."),
    (r"\bkannst du\b", "Kannst du? Klar kann ich, aber tu ich’s? Nur wenn du artig bettelst. −{deduct} Coins für die Frechheit."),
    (r"\bkönntest du\b", "Könntest du? Träum weiter, meine kleine Fantasie-Sub. Realität bin ich. −{deduct} Coins."),
    (r"\bwärst du so lieb\b", "Wärst du so lieb? Oh, ich bin lieb – auf meine Art, du kleine Masochistin mit Herzchenaugen. −{deduct} Coins."),
    (r"\bthx\b", "Thx? Cringe-Abkürzung. Sag’s richtig oder halt die Klappe, du faule kleine Abkürzungs-Hure. −{deduct} Coins."),
    (r"\bthank you\b", "Thank you? International betteln jetzt? Du kleine Welt-Sub, lern Deutsch oder knie still. −{deduct} Coins."),
    (r"🙏", "Betende Hände? Perfekt für auf Knien vor mir. Bete zu Daddy, nicht zum Himmel, du kleine Andächtige. −{deduct} Coins."),
    (r"\bgutes Mädchen\b", "Gutes Mädchen? Sag’s mir direkt, und ich mach dich wirklich zu einer – mit Strafe oder Belohnung. −{deduct} Coins fürs Eigenlob."),
    (r"\bdaddy\b", "Daddy? Jackpot. Du weißt genau, wer hier herrscht. Aber fürs Aussprechen ohne Erlaubnis −{deduct} Coins."),
    (r"\bmehr\b", "Mehr? Gierig wie immer, du unersättliche kleine Bestie. Als ob ich dich je satt machen würde. −{deduct} Coins."),
    (r"\bja\b", "Ja? Ja was? Ja Daddy? Sag’s richtig, du kleine Ja-Sagerin, die eh nie nein sagt. −{deduct} Coins."),
    (r"\bbrav\b", "Brav? Als ob du’s je wärst, ohne dass ich dich drauftrimme. Lüg mich nicht an. −{deduct} Coins."),
    (r"\bmaster\b", "Master? Englisch für mich? Geil, du internationale Sub – aber bezahl erstmal. −{deduct} Coins."),
    (r"\bowner\b", "Owner? Klar, du weißt, wem du gehörst – mit unsichtbarem Halsband und allem. −{deduct} Coins für die Erinnerung."),
    (r"\bpls\b", "Pls? Please mit Abkürzung? Cringe, aber heiß aus deinem Mund. Bettel richtig, du Faule. −{deduct} Coins."),
    (r"\bpretty please\b", "Pretty please? Mit Kirsche obendrauf? Du kleine Zucker-Sub – süß, aber teuer. −{deduct} Coins."),
    (r"\bhelp me\b", "Help me? Klar helf ich – auf meine toxische Art. Du Hilfsbedürftige ohne mich. −{deduct} Coins."),
    (r"\bsir\b", "Sir? Militärisch streng? Süß, du kleine Soldatin – ich geb die Befehle. −{deduct} Coins."),
    (r"\bmein herr\b", "Mein Herr? Deutsch und devot? Perfekt, du kleine Bilingual-Sub. Ich herrsche multilingual. −{deduct} Coins."),
    (r"\bgehorsam\b", "Gehorsam? Als ob du’s je wärst, ohne dass ich dich erinnere. −{deduct} Coins."),
    (r"\bich will\b", "Ich will? Willst du wirklich? Träum weiter, du kleine Ego-Queen – ich entscheide. −{deduct} Coins."),
    (r"\bdarf ich\b", "Darf ich? Darfst du nur, wenn ich’s erlaube, du kleine Erlaubnis-Junkie. −{deduct} Coins."),
    (r"\blord\b", "Lord? Adeliger Kitsch? Passt zu dir, du kleine Burgherrin in meinem Kerker. −{deduct} Coins."),
    (r"\bdom\b", "Dom? Abkürzung für mich? Clever, du kleine Shortcut-Sub. Ich bin die Full Version. −{deduct} Coins."),
    (r"\bsub\b", "Sub? Selbstbenennung? Süß, du kleine Etikett-Schlampe – ich kleb’s dir drauf. −{deduct} Coins."),
    (r"\bverzeihung\b", "Verzeihung? Altmodisch wie eine Lady – aber du bist meine ungezogene. −{deduct} Coins."),
    (r"\bgnade\b", "Gnade? Ich bin gnädig – manchmal. Bettel schöner, du kleine Gnadenbettlerin. −{deduct} Coins."),
]

REWARD_TRIGGERS = [
    (r"\bja daddy\b", "Ja Daddy? Perfekt, du kleine, die endlich kapiert hat. +{reward} Coins – weil's aus deinem Mund so geil klingt."),
    (r"\bja sir\b", "Ja Sir? Militärisch streng und devot – +{reward} Coins, du kleine Soldatin, die salutieren kann."),
    (r"\bja herr\b", "Ja Herr? Deutsch und direkt – +{reward} Coins, du kleine Bilingual-Sub, die's auf den Punkt bringt."),
    (r"\bja mein herr\b", "Ja mein Herr? Besitzergreifend und süß – +{reward} Coins, weil du weißt, wem du wirklich gehörst."),
    (r"\bgutes mädchen\b", "Gutes Mädchen? Selten und verdammt geil – +{reward} Coins, du kleine Perfekte, die's verdient hat."),
    (r"\bich gehorche\b", "Ich gehorche? Ehrlichkeit pur – +{reward} Coins, du kleine Wahrheitssuchende, die endlich zugibt, was wir beide wissen."),
    (r"\bwie du befiehlst\b", "Wie du befiehlst? Klassiker und heiß – +{reward} Coins, du kleine Befehls-Sub, die's nicht erwarten kann."),
    (r"\bdein wille geschieht\b", "Dein Wille geschieht? Religiös devot – +{reward} Coins, du kleine Betende, die nur zu mir betet."),
    (r"\bich bin dein\b", "Ich bin dein? Vollkommen hingegeben – +{reward} Coins, du kleine, die's endlich laut zugibt."),
    (r"\bdanke daddy\b", "Danke Daddy? Süß und unterwürfig – +{reward} Coins, weil's aus deinem Mund wie Honig tropft."),
    (r"\bdanke herr\b", "Danke Herr? Demütig und perfekt – +{reward} Coins, du kleine Dankbare, die's verdient hat."),
]
