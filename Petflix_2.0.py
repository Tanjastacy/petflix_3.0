...
MORAL_TAX_TRIGGERS = [
    ...
    (r"(?i)\bdaddy\b", "Daddy? Jackpot. Du weißt genau, wer hier herrscht. Aber fürs Aussprechen ohne Erlaubnis −{deduct} Coins."),
    (r"(?i)\bmehr\b", "Mehr? Gierig wie immer, du unersättliche kleine Bestie. Als ob ich dich je satt machen würde. −{deduct} Coins."),
    (r"(?i)\bja\b", "Ja? Ja was? Ja Daddy? Sag’s richtig, du kleine Ja-Sagerin, die eh nie nein sagt. −{deduct} Coins."),
    ...
    (r"(?i)\bsir\b", "Sir? Militärisch streng? Süß, du kleine Soldatin – ich geb die Befehle. −{deduct} Coins."),
    (r"(?i)\bmein herr\b", "Mein Herr? Deutsch und devot? Perfekt, du kleine Bilingual-Sub. Ich herrsche multilingual. −{deduct} Coins."),
    (r"(?i)\bgehorsam\b", "Gehorsam? Als ob du’s je wärst, ohne dass ich dich erinnere. −{deduct} Coins."),
    (r"(?i)\bich will\b", "Ich will? Willst du wirklich? Träum weiter, du kleine Ego-Queen – ich entscheide. −{deduct} Coins."),
    (r"(?i)\bdarf ich\b", "Darf ich? Darfst du nur, wenn ich’s erlaube, du kleine Erlaubnis-Junkie. −{deduct} Coins."),
    (r"(?i)\blord\b", "Lord? Adeliger Kitsch? Passt zu dir, du kleine Burgherrin in meinem Kerker. −{deduct} Coins."),
    (r"(?i)\bdom\b", "Dom? Abkürzung für mich? Clever, du kleine Shortcut-Sub. Ich bin die Full Version. −{deduct} Coins."),
    (r"(?i)\bsub\b", "Sub? Selbstbenennung? Süß, du kleine Etikett-Schlampe – ich kleb’s dir drauf. −{deduct} Coins."),
